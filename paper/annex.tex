%% NOTES ON WHAT ABOUT EUDI TO INCLUDE HERE:
...
% For full details, check the eudi_application.tex file
...
29 & Should allow for issuance of eIDs that let someone represent someone else. Not speced out yet, ad-hoc & Unclear & Maybe & We propose including both entities' PKs in the credential where transaction log would show up in represented person's as well. Maybe phone home to person being represented is OK? & Maybe & <<<< \\
\hline
...
33 & Backup devices (e.g. HSM backups) & & Yes & How do HSM backups work? How to ensure they are secure so that credentials aren't stolen \\
\hline
...
48 & Users being able to delete presented data to verifiers & & Yes & Good! \\
\hline
